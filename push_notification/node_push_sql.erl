...
options() ->
    [{sql, true}, {rsm, true} | node_push:options()].

features() ->
    [<<"rsm">> | node_push:features()].

create_node_permission(Host, ServerHost, Node, ParentNode, Owner, Access) ->
    node_push:create_node_permission(Host, ServerHost, Node, ParentNode, Owner, Access).
...
publish_item(Nidx, Publisher, Model, MaxItems, ItemId, Payload, PubOpts) ->
    node_push:publish_item(Nidx, Publisher, Model, MaxItems, ItemId,
	Payload, PubOpts).
